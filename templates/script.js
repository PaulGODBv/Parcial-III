    const preguntas = [
        ...
        { texto: "¿Te has sentido físicamente agotado/a la mayor parte del día?", categoria: "energia" },
        { texto: "¿Has dudado de tu capacidad para superar desafíos?", categoria: "autoestima" },
        { texto: "¿Te ha costado enfocarte en una tarea por más de 20 minutos?", categoria: "concentracion" },
        { texto: "¿Has tenido pensamientos repetitivos sobre problemas sin solución?", categoria: "ansiedad" },
        { texto: "¿Has llorado o sentido una profunda melancolía sin causa aparente?", categoria: "tristeza" },
        ...
        { texto: "¿Te has comparado negativamente con otras personas?", categoria: "autoestima" },
        { texto: "¿Has olvidado detalles importantes en tu trabajo o vida cotidiana?", categoria: "concentracion" },
        ...
        { texto: "¿Has experimentado tensión muscular o dolor por estrés?", categoria: "ansiedad" },
        { texto: "¿Te has aislado de seres queridos sin motivo claro?", categoria: "tristeza" },

        { texto: "¿Has postergado tareas importantes sin una razón clara?", categoria: "motivacion" },
        { texto: "¿Has necesitado hacer pausas frecuentes por cansancio?", categoria: "energia" },
        { texto: "¿Evitas situaciones donde podrías ser juzgado/a?", categoria: "autoestima" },
        { texto: "¿Sientes que tu mente está 'en piloto automático' con frecuencia?", categoria: "concentracion" },
        { texto: "¿Te preocupan excesivamente situaciones futuras?", categoria: "ansiedad" },
        { texto: "¿Sientes que tu estado de ánimo afecta tu productividad?", categoria: "tristeza" },
